...
class MediaObject extends CreativeWork
{
    ...
    public function productionCompany(Organization $company): static
    {
        $this->setProperty('productionCompany', $this->parseChild($company));
        return $this;
    }

    public function regionsAllowed(Place $regionsAllowed): static
    {
        $this->setProperty('regionsAllowed', $this->parseChild($regionsAllowed));
        return $this;
    }
