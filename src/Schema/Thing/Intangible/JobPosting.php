...
use Abdellahramadan\SeoBundle\Schema\Thing\Intangible\StructuredValue\MonetaryValue;
use Abdellahramadan\SeoBundle\Schema\Thing\Intangible\StructuredValue\QuantitativeValueDistribution\MonetaryAmountDistribution;
